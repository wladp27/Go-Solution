...
builder.Services.AddHttpClient("TokenAPIClient", client => client.BaseAddress = new Uri("http://localhost:5186")).AddHttpMessageHandler<AuthorizationMessageHandler>();
builder.Services.AddScoped(sp => new HttpClient { BaseAddress = new Uri("http://localhost:5186") }); //http://localhost:5186/http://201.34.131.23:8080
