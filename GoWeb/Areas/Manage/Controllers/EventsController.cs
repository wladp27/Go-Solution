...
namespace GoWeb.Areas.Manage.Controllers
{
    ...
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            {
                Location = new LocationCreateViewModel() { Cities = selectListCity },
        ...
        public async Task<IActionResult> Create(EventCreateUpdateViewModel eventView)
        {
            ...
            eventView.Location ??= new LocationCreateViewModel();
        ...
        {
            var ev = HttpContext.Items[typeof(Event)] as EventSummaryDTO;
        ...
        private async Task ValidateLocationAndImages(EventCreateUpdateViewModel eventView)
        {
            ...
            if (eventView.LocationId != null)
            {
                ...
                else
                {
                    ...
                    ModelState.Remove("Location.CityId");
                    ModelState.Remove("Location.LocationLatitude");
                    ModelState.Remove("Location.LocationLongitude");
                }
