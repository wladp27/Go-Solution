...
namespace GoWeb.Areas.Admin.Controllers
{
    ...
    public class CitiesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var listCitiesViews = mapper.Map<List<CityDTO>>(listCities);
        ...
        public async Task<IActionResult> Create(CityDTO cityView)
        {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            {
                var cityView = mapper.Map<CityDTO>(city);
                return View(cityView);
            }
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(CityDTO cityView)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            var cityView = mapper.Map<CityDTO>(existingCity);
            return View(cityView); 
        }
