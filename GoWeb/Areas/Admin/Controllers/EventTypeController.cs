  ...
  //  [Authorize(Roles = "Администратор")]
    public class EventTypeController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var listEventTypeView = mapper.Map<List<EventTypeDTO>>(listEventType); 
        ...
        public async Task<IActionResult> Create(EventTypeDTO eventTypeView)
        {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            {
                var eventTypeView = mapper.Map<EventTypeDTO>(eventType);
                return View(eventTypeView);
            }
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(EventTypeDTO eventTypeView)
        {
            if (ModelState.IsValid)
            {
