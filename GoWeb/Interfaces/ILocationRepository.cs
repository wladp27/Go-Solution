...
namespace GoWeb.Interfaces
{
    public interface ILocationRepository
    {
        ...
        public Task<OperationResult<int>> AddAsync(Location location);
        ...
        public Task<OperationResult<List<LocationPreviewDTO>>> GetPreviewLocations(string address, int idCity);
